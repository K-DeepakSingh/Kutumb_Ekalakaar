      ...
      <nav className="navbar bg-light fixed-top" style={{backgroundColor: 'white'}}>
        <div className="container-fluid">
            <div className="left-components">
                ...
                <Navbar/>
                <Link className="navbar-brand " style={{marginLeft: '57px', position:"fixed"}} to="index.html">
    ...
    <div className="view-shortlisted-artist-header container">
      <div className="row">
        <div className="col">
          ...
          <div className="search-data-text text-center"> Applied  artists Applications</div>
        </div>
      </div>
    </div>
    <div className="view-shortlisted-artist-body container">
      {opportunityCards.map((singleoppo,indexs)=>(
        <>

        
        {singleoppo.applied_by.map((userinfo, index)=>(

         userinfo.hired_status === 0? 
           ...
           <div className="card-body">
             <div  style={{marginLeft:"7px"}} className="row view-shortlisted-artist-body-header">
               ...
               {singleoppo.applied_by.length>0? <h3 style={{marginLeft:"17px"}}> Opportunity {indexs + 1}</h3> : ''}
             ...
             <div className="row view-shortlisted-artist-body-footer">
               ...
               <div className="col-auto artist-details">
                 <Link to={`/View_artist_detail/${singleoppo._id}&${userinfo.emailid}`}>
                   View Application
